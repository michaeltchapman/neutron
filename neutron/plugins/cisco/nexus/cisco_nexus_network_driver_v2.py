...
class CiscoNEXUSDriver():
    ...
    def create_vlan(self, vlan_name, vlan_id, nexus_host, nexus_user,
                    nexus_password, nexus_etype, nexus_ports,
        ...
        self.enable_vlan_on_trunk_int(man, nexus_host, nexus_etype, nexus_ports, vlan_ids)

    def delete_vlan(self, vlan_id, nexus_host, nexus_user, nexus_password,
                    nexus_etype, nexus_ports, nexus_ssh_port):
        """Delete vlan.
        ...
        self.disable_vlan_on_trunk_int(man, nexus_etype, nexus_ports, vlan_id)
    ...
    def add_vlan_int(self, vlan_id, nexus_host, nexus_user, nexus_password,
                     nexus_etype, nexus_ports, nexus_ssh_port, vlan_ids=None):
        """Add vlan.
        ...
        for ports in nexus_ports:
            self.enable_vlan_on_trunk_int(man, nexus_host, nexus_etype,
                                          ports, vlan_ids)
