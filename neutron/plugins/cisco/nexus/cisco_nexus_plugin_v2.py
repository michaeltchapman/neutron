...
class NexusPlugin(L2DevicePluginBase):
    ...
    def create_network(self, tenant_id, net_name, net_id, vlan_name, vlan_id,
        ...
        for switch_ip, etype, port_id in host_connections:
            ...
            try:
                ...
                try:
                    ...
                    self._client.create_vlan(
                        ...
                        _nexus_username, _nexus_password, _nexus_etype,
            ...
            try:
                nxos_db.add_nexusport_binding('%s:%s' % (etype, port_id),
                                              str(vlan_id), switch_ip,
                                              instance)
    ...
    def remove_router_interface(self, vlan_id, router_id):
        ...
        row = nxos_db.get_nexusvm_bindings(vlan_id, router_id)[0]
            ...
            try:
                ...
                try:
                    ...
                    if row['port_id'] == 'router':
                        etype, port_id = 'vlan', row['port_id']
                    else:
                        etype, port_id = row['port_id'].split(':')
                    ...
                    self._client.delete_vlan(
                        ...
                        _nexus_username, _nexus_password,
                        _nexus_etype, _nexus_ports, _nexus_ssh_port)
                except Exception as e:
